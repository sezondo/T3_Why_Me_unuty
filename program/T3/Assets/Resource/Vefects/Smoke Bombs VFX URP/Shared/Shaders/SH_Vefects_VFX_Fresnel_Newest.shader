...
Shader "Vefects/SH_Vefects_VFX_Fresnel_Newest"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord22 = input.ase_texcoord4.xy * _NoiseDistortion_Scale + float2( 0,0 );
				...
				float2 texCoord36 = input.ase_texcoord4.xy * _Vector0 + _Mask_Offset;
				float2 panner40 = ( global_speed21 * appendResult39 + texCoord36);
				float2 texCoord49 = input.ase_texcoord4.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed21 * _Noise_01_Speed + texCoord49);
				float2 texCoord46 = input.ase_texcoord4.xy * _Noise_02_Scale + float2( 0,0 );
				...
				float3 Color = ( ( lerpResult97 * (input.ase_color).rgb ) * _Emissive_Intensity );
				float Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( saturate( ( fresnelNode75 + ( 1.0 - distanceDepth67 ) ) ) * saturate( ( saturate( pow( saturate( ( saturate( ( ( tex2D( _TextureSample0, ( ( Distortion34 * _DistortionMask ) + panner40 ) ).r * _Mask_Power ) * _Mask_Multiply ) ) * saturate( ( tex2D( _Noise_01_Texture, ( Distortion34 + panner54 ) ).r * tex2D( _Noise_02_Texture, ( Distortion34 + panner52 ) ).r ) ) ) ) , _Opacity_Power ) ) * _Opacity_Boost ) ) ) ) - ( input.ase_texcoord4.w + _Dissolve ) ) ) * distanceDepth85 ) ) ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float distanceDepth67 = saturate( ( screenDepth67 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade_Distance ) );
				float global_speed21 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord22 = input.ase_texcoord2.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner25 = ( global_speed21 * _NoiseDistortion_Speed + texCoord22);
				float Distortion34 = ( ( tex2D( _NoiseDistortion_Texture, panner25 ).r * 0.1 ) * _NoiseDistortion_Intensity );
				float2 appendResult39 = (float2(0.0 , 0.0));
				float2 texCoord36 = input.ase_texcoord2.xy * _Vector0 + _Mask_Offset;
				float2 panner40 = ( global_speed21 * appendResult39 + texCoord36);
				float2 texCoord49 = input.ase_texcoord2.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed21 * _Noise_01_Speed + texCoord49);
				float2 texCoord46 = input.ase_texcoord2.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner52 = ( global_speed21 * _Noise_02_Speed + texCoord46);
				float screenDepth85 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth85 = saturate( ( screenDepth85 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Opacity_DepthFade_Intensity ) );
				

				surfaceDescription.Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( saturate( ( fresnelNode75 + ( 1.0 - distanceDepth67 ) ) ) * saturate( ( saturate( pow( saturate( ( saturate( ( ( tex2D( _TextureSample0, ( ( Distortion34 * _DistortionMask ) + panner40 ) ).r * _Mask_Power ) * _Mask_Multiply ) ) * saturate( ( tex2D( _Noise_01_Texture, ( Distortion34 + panner54 ) ).r * tex2D( _Noise_02_Texture, ( Distortion34 + panner52 ) ).r ) ) ) ) , _Opacity_Power ) ) * _Opacity_Boost ) ) ) ) - ( input.ase_texcoord2.w + _Dissolve ) ) ) * distanceDepth85 ) ) ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float distanceDepth67 = saturate( ( screenDepth67 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade_Distance ) );
				float global_speed21 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord22 = input.ase_texcoord3.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner25 = ( global_speed21 * _NoiseDistortion_Speed + texCoord22);
				float Distortion34 = ( ( tex2D( _NoiseDistortion_Texture, panner25 ).r * 0.1 ) * _NoiseDistortion_Intensity );
				float2 appendResult39 = (float2(0.0 , 0.0));
				float2 texCoord36 = input.ase_texcoord3.xy * _Vector0 + _Mask_Offset;
				float2 panner40 = ( global_speed21 * appendResult39 + texCoord36);
				float2 texCoord49 = input.ase_texcoord3.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed21 * _Noise_01_Speed + texCoord49);
				float2 texCoord46 = input.ase_texcoord3.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner52 = ( global_speed21 * _Noise_02_Speed + texCoord46);
				float screenDepth85 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth85 = saturate( ( screenDepth85 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Opacity_DepthFade_Intensity ) );
				

				float Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( saturate( ( fresnelNode75 + ( 1.0 - distanceDepth67 ) ) ) * saturate( ( saturate( pow( saturate( ( saturate( ( ( tex2D( _TextureSample0, ( ( Distortion34 * _DistortionMask ) + panner40 ) ).r * _Mask_Power ) * _Mask_Multiply ) ) * saturate( ( tex2D( _Noise_01_Texture, ( Distortion34 + panner54 ) ).r * tex2D( _Noise_02_Texture, ( Distortion34 + panner52 ) ).r ) ) ) ) , _Opacity_Power ) ) * _Opacity_Boost ) ) ) ) - ( input.ase_texcoord3.w + _Dissolve ) ) ) * distanceDepth85 ) ) ) );
				float AlphaClipThreshold = 0.5;
...
Node;AmplifyShaderEditor.SamplerNode;26;-4608,-832;Inherit;True;Property;_NoiseDistortion_Texture;NoiseDistortion_Texture;5;0;Create;True;0;0;0;False;0;False;-1;02b0d0a96eedb3d4fa5664350b35ba23;02b0d0a96eedb3d4fa5664350b35ba23;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;53;-4384,432;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;109;-5744,-272;Inherit;True;Property;_Mask_Texture;Mask_Texture;0;0;Create;True;0;0;0;False;0;False;-1;2b03b59c1f786984297d70163e795d57;2b03b59c1f786984297d70163e795d57;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;115;-1568,-848;Inherit;False;Property;_Color_2;Color_2;26;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;121;-1568,-1072;Inherit;False;Property;_Color_1;Color_1;27;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_VFX_Fresnel_Newest;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638463808423533785;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638861199369410880;  Use Shadow Threshold;0;0;Cast Shadows;0;638463808434011469;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;130;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=684D6362C83CD9568D595C15F28E8E0CA6B4F6CE