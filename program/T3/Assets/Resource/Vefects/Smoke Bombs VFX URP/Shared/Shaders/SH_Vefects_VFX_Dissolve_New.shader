	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord23 = input.ase_texcoord5.xy * _NoiseDistortion_Scale + float2( 0,0 );
				...
				float2 texCoord47 = input.ase_texcoord5.xy * _Mask_Scale + _Mask_Offset;
				...
				float2 texCoord59 = input.ase_texcoord5.xy * _MaskMove_Scale + float2( 0,0 );
				...
				float2 texCoord40 = input.ase_texcoord5.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner48 = ( global_speed22 * _Noise_01_Speed + texCoord40);
				float2 texCoord38 = input.ase_texcoord5.xy * _Noise_02_Scale + float2( 0,0 );
				...
				float temp_output_120_0 = saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( input.ase_texcoord6.x + _Dissolve ) ) * distanceDepth94 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float lerpResult138 = lerp( 1.0 , lerpResult144 , _IsFresnel);
				float global_speed22 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord23 = input.ase_texcoord4.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner26 = ( global_speed22 * _NoiseDistortion_Speed + texCoord23);
				float Distortion36 = ( ( tex2D( _NoiseDistortion_Texture, panner26 ).g * 0.1 ) * _Distortion );
				float2 appendResult44 = (float2(_Mask_Speed , 0.0));
				float2 texCoord47 = input.ase_texcoord4.xy * _Mask_Scale + _Mask_Offset;
				float2 panner56 = ( global_speed22 * appendResult44 + texCoord47);
				float4 tex2DNode70 = tex2D( _Mask_Texture, ( ( Distortion36 * _DistortionMask ) + panner56 ) );
				float2 texCoord59 = input.ase_texcoord4.xy * _MaskMove_Scale + float2( 0,0 );
				float2 appendResult57 = (float2(input.ase_texcoord5.z , input.ase_texcoord5.w));
				float4 tex2DNode68 = tex2D( _MaskMove_Texture, ( texCoord59 + appendResult57 ) );
				float temp_output_83_0 = ( saturate( ( saturate( pow( tex2DNode70.g , _Mask_Power ) ) * _Mask_Multiply ) ) * saturate( ( pow( tex2DNode68.g , _MaskMove_Power ) * _MaskMove_Multiply ) ) );
				float2 texCoord40 = input.ase_texcoord4.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner48 = ( global_speed22 * _Noise_01_Speed + texCoord40);
				float2 texCoord38 = input.ase_texcoord4.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed22 * _Noise_02_Speed + texCoord38);
				float noise84 = saturate( ( ( ( tex2D( _Noise_01_Texture, ( Distortion36 + panner48 ) ).g * tex2D( _Noise_02_Texture, ( Distortion36 + panner54 ) ).g ) * _Noises_Power ) * _Noises_Multiply ) );
				float temp_output_87_0 = ( saturate( temp_output_83_0 ) * noise84 );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				...
				float screenDepth94 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth94 = saturate( ( screenDepth94 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Opacity_DepthDistance ) );
				float temp_output_120_0 = saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( input.ase_texcoord5.x + _Dissolve ) ) * distanceDepth94 ) );
				float temp_output_121_0 = saturate( ( input.ase_color.a * ( lerpResult138 * temp_output_120_0 ) ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float lerpResult138 = lerp( 1.0 , lerpResult144 , _IsFresnel);
				float global_speed22 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord23 = input.ase_texcoord2.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner26 = ( global_speed22 * _NoiseDistortion_Speed + texCoord23);
				float Distortion36 = ( ( tex2D( _NoiseDistortion_Texture, panner26 ).g * 0.1 ) * _Distortion );
				float2 appendResult44 = (float2(_Mask_Speed , 0.0));
				float2 texCoord47 = input.ase_texcoord2.xy * _Mask_Scale + _Mask_Offset;
				float2 panner56 = ( global_speed22 * appendResult44 + texCoord47);
				float4 tex2DNode70 = tex2D( _Mask_Texture, ( ( Distortion36 * _DistortionMask ) + panner56 ) );
				float2 texCoord59 = input.ase_texcoord2.xy * _MaskMove_Scale + float2( 0,0 );
				float2 appendResult57 = (float2(input.ase_texcoord3.z , input.ase_texcoord3.w));
				float4 tex2DNode68 = tex2D( _MaskMove_Texture, ( texCoord59 + appendResult57 ) );
				float temp_output_83_0 = ( saturate( ( saturate( pow( tex2DNode70.g , _Mask_Power ) ) * _Mask_Multiply ) ) * saturate( ( pow( tex2DNode68.g , _MaskMove_Power ) * _MaskMove_Multiply ) ) );
				float2 texCoord40 = input.ase_texcoord2.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner48 = ( global_speed22 * _Noise_01_Speed + texCoord40);
				float2 texCoord38 = input.ase_texcoord2.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed22 * _Noise_02_Speed + texCoord38);
				float noise84 = saturate( ( ( ( tex2D( _Noise_01_Texture, ( Distortion36 + panner48 ) ).g * tex2D( _Noise_02_Texture, ( Distortion36 + panner54 ) ).g ) * _Noises_Power ) * _Noises_Multiply ) );
				float temp_output_87_0 = ( saturate( temp_output_83_0 ) * noise84 );
				...
				float screenDepth94 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth94 = saturate( ( screenDepth94 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Opacity_DepthDistance ) );
				float temp_output_120_0 = saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( input.ase_texcoord3.x + _Dissolve ) ) * distanceDepth94 ) );
				float temp_output_121_0 = saturate( ( input.ase_color.a * ( lerpResult138 * temp_output_120_0 ) ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float lerpResult138 = lerp( 1.0 , lerpResult144 , _IsFresnel);
				float global_speed22 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord23 = input.ase_texcoord3.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner26 = ( global_speed22 * _NoiseDistortion_Speed + texCoord23);
				float Distortion36 = ( ( tex2D( _NoiseDistortion_Texture, panner26 ).g * 0.1 ) * _Distortion );
				float2 appendResult44 = (float2(_Mask_Speed , 0.0));
				float2 texCoord47 = input.ase_texcoord3.xy * _Mask_Scale + _Mask_Offset;
				float2 panner56 = ( global_speed22 * appendResult44 + texCoord47);
				float4 tex2DNode70 = tex2D( _Mask_Texture, ( ( Distortion36 * _DistortionMask ) + panner56 ) );
				float2 texCoord59 = input.ase_texcoord3.xy * _MaskMove_Scale + float2( 0,0 );
				float2 appendResult57 = (float2(input.ase_texcoord4.z , input.ase_texcoord4.w));
				float4 tex2DNode68 = tex2D( _MaskMove_Texture, ( texCoord59 + appendResult57 ) );
				float temp_output_83_0 = ( saturate( ( saturate( pow( tex2DNode70.g , _Mask_Power ) ) * _Mask_Multiply ) ) * saturate( ( pow( tex2DNode68.g , _MaskMove_Power ) * _MaskMove_Multiply ) ) );
				float2 texCoord40 = input.ase_texcoord3.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner48 = ( global_speed22 * _Noise_01_Speed + texCoord40);
				float2 texCoord38 = input.ase_texcoord3.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed22 * _Noise_02_Speed + texCoord38);
				float noise84 = saturate( ( ( ( tex2D( _Noise_01_Texture, ( Distortion36 + panner48 ) ).g * tex2D( _Noise_02_Texture, ( Distortion36 + panner54 ) ).g ) * _Noises_Power ) * _Noises_Multiply ) );
				float temp_output_87_0 = ( saturate( temp_output_83_0 ) * noise84 );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				...
				float screenDepth94 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth94 = saturate( ( screenDepth94 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Opacity_DepthDistance ) );
				float temp_output_120_0 = saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( input.ase_texcoord4.x + _Dissolve ) ) * distanceDepth94 ) );
				float temp_output_121_0 = saturate( ( input.ase_color.a * ( lerpResult138 * temp_output_120_0 ) ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;145;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=F11D04DC297D02D741357FB415A8FB04176AD33C