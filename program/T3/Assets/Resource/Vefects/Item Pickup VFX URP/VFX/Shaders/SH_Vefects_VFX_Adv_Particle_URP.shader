	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord251 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord30 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord216 = input.ase_texcoord4.xy * _Mask_Scale + _Mask_Offset;
				...
				float2 texCoord26 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float temp_output_344_0 = saturate( ( ( temp_output_227_0 - ( _Erosion_Sub + input.ase_texcoord4.z ) ) * clampResult341 ) );
				...
				float temp_output_309_0 = saturate( ( input.ase_color.a * ( temp_output_344_0 * saturate( distanceDepth137 ) ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( ( ( float4( lerpResult353 , 0.0 ) * ( input.ase_color * float4( (Color329).rgb , 0.0 ) ) ) * temp_output_344_0 ) * temp_output_309_0 ) * _EmissiveIntensity ) * input.ase_texcoord4.w ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float windSpeed200 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord30 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner79 = ( windSpeed200 * _NoiseDistortion_Speed + ( texCoord30 * _NoiseDistortion_Scale ));
				float Distortion64 = ( ( tex2D( _NoiseDistortion_Texture, panner79 ).r * 0.1 ) * _DistortionAmount );
				float2 texCoord216 = input.ase_texcoord3.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord26 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner78 = ( windSpeed200 * _Noise_01_Speed + ( texCoord26 * _Noise_01_Scale ));
				float noises205 = saturate( ( pow( tex2D( _Noise_01_Texture, ( panner78 + Distortion64 ) ).r , _Noises_Power ) * _Noises_Multiply ) );
				float lerpResult339 = lerp( temp_output_227_0 , noises205 , _Erosion_Intensity);
				float clampResult341 = clamp( lerpResult339 , 0.0 , 1.0 );
				float temp_output_344_0 = saturate( ( ( temp_output_227_0 - ( _Erosion_Sub + input.ase_texcoord3.z ) ) * clampResult341 ) );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth137 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth137 = saturate( ( screenDepth137 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float windSpeed200 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord30 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner79 = ( windSpeed200 * _NoiseDistortion_Speed + ( texCoord30 * _NoiseDistortion_Scale ));
				float Distortion64 = ( ( tex2D( _NoiseDistortion_Texture, panner79 ).r * 0.1 ) * _DistortionAmount );
				float2 texCoord216 = input.ase_texcoord.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord26 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner78 = ( windSpeed200 * _Noise_01_Speed + ( texCoord26 * _Noise_01_Scale ));
				float noises205 = saturate( ( pow( tex2D( _Noise_01_Texture, ( panner78 + Distortion64 ) ).r , _Noises_Power ) * _Noises_Multiply ) );
				float lerpResult339 = lerp( temp_output_227_0 , noises205 , _Erosion_Intensity);
				float clampResult341 = clamp( lerpResult339 , 0.0 , 1.0 );
				float temp_output_344_0 = saturate( ( ( temp_output_227_0 - ( _Erosion_Sub + input.ase_texcoord.z ) ) * clampResult341 ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float windSpeed200 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord30 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner79 = ( windSpeed200 * _NoiseDistortion_Speed + ( texCoord30 * _NoiseDistortion_Scale ));
				float Distortion64 = ( ( tex2D( _NoiseDistortion_Texture, panner79 ).r * 0.1 ) * _DistortionAmount );
				float2 texCoord216 = input.ase_texcoord2.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord26 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner78 = ( windSpeed200 * _Noise_01_Speed + ( texCoord26 * _Noise_01_Scale ));
				float noises205 = saturate( ( pow( tex2D( _Noise_01_Texture, ( panner78 + Distortion64 ) ).r , _Noises_Power ) * _Noises_Multiply ) );
				float lerpResult339 = lerp( temp_output_227_0 , noises205 , _Erosion_Intensity);
				float clampResult341 = clamp( lerpResult339 , 0.0 , 1.0 );
				float temp_output_344_0 = saturate( ( ( temp_output_227_0 - ( _Erosion_Sub + input.ase_texcoord2.z ) ) * clampResult341 ) );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth137 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth137 = saturate( ( screenDepth137 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;373;1882.7,54.73748;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_VFX_Adv_Particle_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;2;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638689848447680967;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638689848464156347;  Use Shadow Threshold;0;0;Cast Shadows;0;638689848469886245;Receive Shadows;0;638689848472347691;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;638689848480146440;Built-in Fog;0;638689848487429600;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;382;1882.7,154.7375;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=B93996C64FC632DBC13C2BE7B9D095F4B0929427