	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 lerpResult57 = lerp( IN.ase_color , lerpResult38 , _CoreColorDifferent);
				...
				float4 temp_output_30_0 = ( saturate( lerpResult23 ) + ( IN.ase_texcoord5.z + _DissolveEro ) );
				...
				float Alpha = saturate( ( ( IN.ase_color.a * saturate( step( temp_output_52_0 , temp_cast_2 ) ) ) + step( ( ( IN.ase_color.a + temp_output_52_0 ) + _AddDiss ) , temp_cast_3 ) ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode16 = tex2D( _DissolveTexture, panner19 );
				float4 lerpResult23 = lerp( tex2DNode16 , ( 1.0 - tex2DNode16 ) , _DissolveInvert);
				float4 temp_output_30_0 = ( saturate( lerpResult23 ) + ( IN.ase_texcoord3.z + _DissolveEro ) );
				...
				float Alpha = saturate( ( ( IN.ase_color.a * saturate( step( temp_output_52_0 , temp_cast_1 ) ) ) + step( ( ( IN.ase_color.a + temp_output_52_0 ) + _AddDiss ) , temp_cast_2 ) ) ).r;
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode16 = tex2D( _DissolveTexture, panner19 );
				float4 lerpResult23 = lerp( tex2DNode16 , ( 1.0 - tex2DNode16 ) , _DissolveInvert);
				float4 temp_output_30_0 = ( saturate( lerpResult23 ) + ( IN.ase_texcoord.z + _DissolveEro ) );
				float4 temp_cast_0 = (_CorePower).xxxx;
				float4 temp_output_52_0 = saturate( ( ( pow( temp_output_30_0 , temp_cast_0 ) * _CoreIntensity ) + ( temp_output_30_0 * _GlowIntensity ) ) );
				...
				surfaceDescription.Alpha = saturate( ( ( IN.ase_color.a * saturate( step( temp_output_52_0 , temp_cast_1 ) ) ) + step( ( ( IN.ase_color.a + temp_output_52_0 ) + _AddDiss ) , temp_cast_2 ) ) ).r;
		...
		Pass
		{
				 ...
				 )
			{
				...
				float4 tex2DNode16 = tex2D( _DissolveTexture, panner19 );
				float4 lerpResult23 = lerp( tex2DNode16 , ( 1.0 - tex2DNode16 ) , _DissolveInvert);
				float4 temp_output_30_0 = ( saturate( lerpResult23 ) + ( IN.ase_texcoord2.z + _DissolveEro ) );
				float4 temp_cast_0 = (_CorePower).xxxx;
				float4 temp_output_52_0 = saturate( ( ( pow( temp_output_30_0 , temp_cast_0 ) * _CoreIntensity ) + ( temp_output_30_0 * _GlowIntensity ) ) );
				float3 ase_worldPos = IN.ase_texcoord3.xyz;
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float fresnelNdotV62 = dot( IN.clipPosV.xyz, ase_viewDirWS );
				float fresnelNode62 = ( _FrBias1 + _FrScale1 * pow( 1.0 - fresnelNdotV62, _FrPower1 ) );
				float temp_output_78_0 = saturate( fresnelNode62 );
				float4 temp_cast_1 = (temp_output_78_0).xxxx;
				float fresnelNdotV39 = dot( IN.clipPosV.xyz, ase_viewDirWS );
				float fresnelNode39 = ( _FrColorBias + _FrColorScale * pow( 1.0 - fresnelNdotV39, _FrColorPower ) );
				float temp_output_43_0 = saturate( fresnelNode39 );
				float4 temp_cast_2 = (temp_output_43_0).xxxx;
...
Node;AmplifyShaderEditor.Vector2Node;20;-6272,128;Inherit;False;Property;_DissolveUVScale;Dissolve UV Scale;1;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;21;-5760,128;Inherit;False;Property;_DissolveUVSpeed;Dissolve UV Speed;2;0;Create;True;0;0;0;False;0;False;0,0.3;0,0.3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-4224,512;Inherit;False;Property;_DissolveEro;Dissolve Ero;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;-3712,-128;Inherit;False;Property;_CorePower;Core Power;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;45;-3712,0;Inherit;False;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-3712,384;Inherit;False;Property;_GlowIntensity;Glow Intensity;15;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-3456,-128;Inherit;False;Property;_CoreIntensity;Core Intensity;14;0;Create;True;0;0;0;False;0;False;0.6;0.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-2176,128;Inherit;False;Property;_FrScale1;Fr Scale;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;64;-2176,256;Inherit;False;Property;_FrBias1;Fr Bias;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-2176,384;Inherit;False;Property;_FrPower1;Fr Power;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-2944,1536;Inherit;False;Property;_FrColorBias;Fr Color Bias;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-2944,1408;Inherit;False;Property;_FrColorScale;Fr Color Scale;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-2944,1664;Inherit;False;Property;_FrColorPower;Fr Color Power;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2816,384;Inherit;False;Property;_AddDiss;Add Diss;16;0;Create;True;0;0;0;False;0;False;-0.690476;-0.690476;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;512,0;Inherit;False;Property;_Cull;Cull;20;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;768,0;Inherit;False;Property;_Src;Src;21;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;1024,0.7006989;Inherit;False;Property;_Dst;Dst;22;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;1280,0;Inherit;False;Property;_ZWrite;ZWrite;23;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;1536,0;Inherit;False;Property;_ZTest;ZTest;24;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;35;-2944,896;Inherit;False;Property;_ColorIn;Color In;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;37;-2944,1152;Inherit;False;Property;_ColorExt;Color Ext;6;0;Create;True;0;0;0;False;0;False;0,0.6901961,1,0;0,0.6897702,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-2176,-512;Inherit;False;Property;_CoreColorDifferent;Core Color Different;17;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-2048,512;Inherit;False;Property;_DepthFade;Depth Fade;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1920,-384;Inherit;False;Property;_Brightness;Brightness;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_VFX_Fresnel_Bomb;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;2;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638463264845950016;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638775443929985987;  Use Shadow Threshold;0;0;Cast Shadows;0;638463266204850631;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=2DCF58C9CAAB3510096D159F8B5F5BBD3874984B