	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord19 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner27 = ( 1.0 * _Time.y * _UVP + ( texCoord19 * _UVS ));
				float2 texCoord11 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord95 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float smoothstepResult55 = smoothstep( input.ase_texcoord4.z , ( input.ase_texcoord4.z + _ErosionSmoothness ) , mainTex_alpha48);
				float mainTex_VC_alha52 = input.ase_color.a;
				float Opacity_VTC_W33 = input.ase_texcoord4.z;
				float Opacity_VTC_T30 = input.ase_texcoord4.w;
				float temp_output_44_0 = (( Opacity_VTC_T30 - 1.0 ) + (Opacity_VTC_W33 - 0.0) * (1.0 - ( Opacity_VTC_T30 - 1.0 )) / (1.0 - 0.0));
				float2 uv_disolveMap = input.ase_texcoord4.xy * _disolveMap_ST.xy + _disolveMap_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float mainTex_VC_alha52 = input.ase_color.a;
				float Opacity_VTC_W33 = input.ase_texcoord.z;
				float Opacity_VTC_T30 = input.ase_texcoord.w;
				float temp_output_44_0 = (( Opacity_VTC_T30 - 1.0 ) + (Opacity_VTC_W33 - 0.0) * (1.0 - ( Opacity_VTC_T30 - 1.0 )) / (1.0 - 0.0));
				float2 uv_disolveMap = input.ase_texcoord.xy * _disolveMap_ST.xy + _disolveMap_ST.zw;
				float smoothstepResult54 = smoothstep( temp_output_44_0 , ( temp_output_44_0 + Opacity_VTC_T30 ) , tex2D( _disolveMap, uv_disolveMap ).r);
				float disolveMapping56 = smoothstepResult54;
				float OpacityRegister61 = ( ( smoothstepResult55 * mainTex_VC_alha52 ) * disolveMapping56 );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float mainTex_VC_alha52 = input.ase_color.a;
				float Opacity_VTC_W33 = input.ase_texcoord2.z;
				float Opacity_VTC_T30 = input.ase_texcoord2.w;
				float temp_output_44_0 = (( Opacity_VTC_T30 - 1.0 ) + (Opacity_VTC_W33 - 0.0) * (1.0 - ( Opacity_VTC_T30 - 1.0 )) / (1.0 - 0.0));
				float2 uv_disolveMap = input.ase_texcoord2.xy * _disolveMap_ST.xy + _disolveMap_ST.zw;
				float smoothstepResult54 = smoothstep( temp_output_44_0 , ( temp_output_44_0 + Opacity_VTC_T30 ) , tex2D( _disolveMap, uv_disolveMap ).r);
				float disolveMapping56 = smoothstepResult54;
				float OpacityRegister61 = ( ( smoothstepResult55 * mainTex_VC_alha52 ) * disolveMapping56 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_Unlit_Flipbook_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;2;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638490814449923107;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638689913380789699;  Use Shadow Threshold;0;0;Cast Shadows;0;638490812733195615;Receive Shadows;0;638689913394536334;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;638689913409654563;Built-in Fog;0;638689913418545696;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
ASEEND*/
//CHKSM=A346AA75755FDC3A8DE1B18E5EF1FA0C0947CFB5