...
Shader "Vefects/SH_Vefects_VFX_Adv_Particle_Move_URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 appendResult157 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + input.ase_texcoord4.w )));
				float2 texCoord164 = input.ase_texcoord4.xy * _Mask_Scale + appendResult157;
				...
				float4 lerpResult198 = lerp( _ColorBottom , _ColorTop , tex2D( _ColorGradientMask, panner202 ).r);
				...
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _Erosion_Sub + input.ase_texcoord4.z ) ) ) * saturate( lerpResult181 ) ) ) * distanceDepth188 ) );
				float temp_output_230_0 = saturate( ( input.ase_color.a * temp_output_235_0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( ( float4( lerpResult200 , 0.0 ) * ( input.ase_color * float4( (Color203).rgb , 0.0 ) ) ) * temp_output_235_0 ) * temp_output_230_0 ) * _EmissiveIntensity ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 panner136 = ( windSpeed131 * _Distortion_Speed + ( texCoord130 * _Distortion_Scale ));
				float Distortion149 = ( ( tex2D( _Distortion_Texture, panner136 ).r * 0.1 ) * _Distortion_Amount );
				float2 appendResult157 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + input.ase_texcoord3.w )));
				float2 texCoord164 = input.ase_texcoord3.xy * _Mask_Scale + appendResult157;
				float4 tex2DNode170 = tex2D( _Mask_Texture, ( ( Distortion149 * _DistortionMaskIntensity ) + texCoord164 ) );
				float temp_output_180_0 = saturate( ( pow( tex2DNode170.r , _Mask_Power ) * _Mask_Multiply ) );
				...
				float screenDepth188 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth188 = saturate( ( screenDepth188 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _Erosion_Sub + input.ase_texcoord3.z ) ) ) * saturate( lerpResult181 ) ) ) * distanceDepth188 ) );
				float temp_output_230_0 = saturate( ( input.ase_color.a * temp_output_235_0 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 panner136 = ( windSpeed131 * _Distortion_Speed + ( texCoord130 * _Distortion_Scale ));
				float Distortion149 = ( ( tex2D( _Distortion_Texture, panner136 ).r * 0.1 ) * _Distortion_Amount );
				float2 appendResult157 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + input.ase_texcoord.w )));
				float2 texCoord164 = input.ase_texcoord.xy * _Mask_Scale + appendResult157;
				float4 tex2DNode170 = tex2D( _Mask_Texture, ( ( Distortion149 * _DistortionMaskIntensity ) + texCoord164 ) );
				float temp_output_180_0 = saturate( ( pow( tex2DNode170.r , _Mask_Power ) * _Mask_Multiply ) );
				...
				float screenDepth188 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth188 = saturate( ( screenDepth188 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _Erosion_Sub + input.ase_texcoord.z ) ) ) * saturate( lerpResult181 ) ) ) * distanceDepth188 ) );
				float temp_output_230_0 = saturate( ( input.ase_color.a * temp_output_235_0 ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 panner136 = ( windSpeed131 * _Distortion_Speed + ( texCoord130 * _Distortion_Scale ));
				float Distortion149 = ( ( tex2D( _Distortion_Texture, panner136 ).r * 0.1 ) * _Distortion_Amount );
				float2 appendResult157 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + input.ase_texcoord2.w )));
				float2 texCoord164 = input.ase_texcoord2.xy * _Mask_Scale + appendResult157;
				float4 tex2DNode170 = tex2D( _Mask_Texture, ( ( Distortion149 * _DistortionMaskIntensity ) + texCoord164 ) );
				float temp_output_180_0 = saturate( ( pow( tex2DNode170.r , _Mask_Power ) * _Mask_Multiply ) );
				...
				float screenDepth188 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth188 = saturate( ( screenDepth188 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_235_0 = saturate( ( saturate( ( saturate( ( temp_output_180_0 - ( _Erosion_Sub + input.ase_texcoord2.z ) ) ) * saturate( lerpResult181 ) ) ) * distanceDepth188 ) );
				float temp_output_230_0 = saturate( ( input.ase_color.a * temp_output_235_0 ) );
...
Node;AmplifyShaderEditor.CommentaryNode;184;-1936.238,882.7104;Inherit;False;797.8698;686.7385;Depth Fade;5;235;192;190;188;186;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;138;-5897.243,-2734.493;Inherit;True;Property;_Distortion_Texture;Distortion_Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.Vector2Node;143;-9594.237,-875.2904;Inherit;False;Property;_Erosion_Scale;Erosion_Scale;6;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SaturateNode;236;-2922.511,184.0836;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;237;-2896,704;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;235;-1300.634,1150.089;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;204;-3698.662,-2559.497;Inherit;False;Property;_ColorTop;Color Top;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;205;-3698.662,-2815.497;Inherit;False;Property;_ColorBottom;Color Bottom;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_VFX_Adv_Particle_Move_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638463808423533785;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638689749655389898;  Use Shadow Threshold;0;0;Cast Shadows;0;638463808434011469;Receive Shadows;0;638689749660819777;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;238;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;237;0;181;0
WireConnection;187;0;236;0
WireConnection;187;1;237;0
...
ASEEND*/
//CHKSM=E2B56CC78724BA85E70B0467A40B78B6AD865C69