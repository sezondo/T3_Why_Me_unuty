	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord21 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord50 = input.ase_texcoord4.xy * _Mask_Scale + _Mask_Offset;
				...
				float2 texCoord107 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner105 = ( windSpeed22 * _GradientColor_Speed + ( texCoord107 * _GradientColor_Scale ));
				float4 lerpResult116 = lerp( _ColorBottom , _ColorTop , tex2D( _ColorGradientMask, panner105 ).r);
				float4 Color117 = lerpResult116;
				float temp_output_67_0 = saturate( ( pow( tex2DNode58.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord34 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + input.ase_texcoord4.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( input.ase_color.a * temp_output_86_0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( ( ( float4( lerpResult106 , 0.0 ) * ( input.ase_color * float4( (Color117).rgb , 0.0 ) ) ) * temp_output_86_0 ) * temp_output_97_0 ) * _EmissiveIntensity ) * input.ase_texcoord4.w ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 panner27 = ( windSpeed22 * _Distortion_Speed + ( texCoord21 * _Distortion_Scale ));
				float Distortion37 = ( ( tex2D( _Distortion_Texture, panner27 ).r * 0.1 ) * _Distortion_Amount );
				float2 texCoord50 = input.ase_texcoord3.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode58 = tex2D( _Mask_Texture, ( ( Distortion37 * _DistortionMaskIntensity ) + texCoord50 ) );
				float temp_output_67_0 = saturate( ( pow( tex2DNode58.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord34 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner42 = ( windSpeed22 * _Erosion_Speed + ( texCoord34 * _Erosion_Scale ));
				float noises62 = saturate( ( pow( tex2D( _Erosion_Texture, ( panner42 + Distortion37 ) ).r , _Erosion_Power ) * _Erosion_Multiply ) );
				float lerpResult69 = lerp( temp_output_67_0 , noises62 , _Erosion_Intensity);
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + input.ase_texcoord3.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( input.ase_color.a * temp_output_86_0 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 panner27 = ( windSpeed22 * _Distortion_Speed + ( texCoord21 * _Distortion_Scale ));
				float Distortion37 = ( ( tex2D( _Distortion_Texture, panner27 ).r * 0.1 ) * _Distortion_Amount );
				float2 texCoord50 = input.ase_texcoord.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode58 = tex2D( _Mask_Texture, ( ( Distortion37 * _DistortionMaskIntensity ) + texCoord50 ) );
				float temp_output_67_0 = saturate( ( pow( tex2DNode58.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord34 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner42 = ( windSpeed22 * _Erosion_Speed + ( texCoord34 * _Erosion_Scale ));
				float noises62 = saturate( ( pow( tex2D( _Erosion_Texture, ( panner42 + Distortion37 ) ).r , _Erosion_Power ) * _Erosion_Multiply ) );
				float lerpResult69 = lerp( temp_output_67_0 , noises62 , _Erosion_Intensity);
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + input.ase_texcoord.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( input.ase_color.a * temp_output_86_0 ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float windSpeed22 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord21 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner27 = ( windSpeed22 * _Distortion_Speed + ( texCoord21 * _Distortion_Scale ));
				float Distortion37 = ( ( tex2D( _Distortion_Texture, panner27 ).r * 0.1 ) * _Distortion_Amount );
				float2 texCoord50 = input.ase_texcoord2.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode58 = tex2D( _Mask_Texture, ( ( Distortion37 * _DistortionMaskIntensity ) + texCoord50 ) );
				float temp_output_67_0 = saturate( ( pow( tex2DNode58.r , _Mask_Power ) * _Mask_Multiply ) );
				float2 texCoord34 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner42 = ( windSpeed22 * _Erosion_Speed + ( texCoord34 * _Erosion_Scale ));
				float noises62 = saturate( ( pow( tex2D( _Erosion_Texture, ( panner42 + Distortion37 ) ).r , _Erosion_Power ) * _Erosion_Multiply ) );
				float lerpResult69 = lerp( temp_output_67_0 , noises62 , _Erosion_Intensity);
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + input.ase_texcoord2.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( input.ase_color.a * temp_output_86_0 ) );
...
Node;AmplifyShaderEditor.CommentaryNode;73;-1232,1600;Inherit;False;1170;806;Camera Offset;9;92;89;85;84;83;82;81;78;77;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;74;-2192,752;Inherit;False;806.7917;692.1095;Depth Fade;5;86;90;79;87;76;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-8544,-2912;Inherit;False;Property;_WindSpeed;Wind Speed;24;0;Create;True;0;0;0;False;0;False;1;-0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;23;-7312,-2736;Inherit;False;Property;_Distortion_Scale;Distortion_Scale;9;0;Create;True;0;0;0;False;0;False;1,1;7,0.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.GetLocalVarNode;24;-6656,-2592;Inherit;False;22;windSpeed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;25;-6880,-2768;Inherit;False;Property;_Distortion_Speed;Distortion_Speed;13;0;Create;True;0;0;0;False;0;False;0,0;0.4,-0.75;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;28;-6160,-2864;Inherit;True;Property;_Distortion_Texture;Distortion_Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-5760,-2688;Inherit;False;Property;_Distortion_Amount;Distortion_Amount;20;0;Create;True;0;0;0;False;0;False;0;2.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;35;-9856,-1008;Inherit;False;Property;_Erosion_Scale;Erosion_Scale;6;0;Create;True;0;0;0;False;0;False;1,1;10,0.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;39;-9472,-1008;Inherit;False;Property;_Erosion_Speed;Erosion_Speed;10;0;Create;True;0;0;0;False;0;False;0,0;0.1,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;44;-6528,144;Inherit;False;Property;_Mask_Scale;Mask_Scale;11;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.GetLocalVarNode;45;-6480,-416;Inherit;False;37;Distortion;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-6480,-288;Inherit;False;Property;_DistortionMaskIntensity;Distortion Mask Intensity;21;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;47;-6528,400;Inherit;False;Property;_Mask_Offset;Mask_Offset;12;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-8320,-992;Inherit;False;Property;_Erosion_Power;Erosion_Power;19;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-8064,-992;Inherit;False;Property;_Erosion_Multiply;Erosion_Multiply;17;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-5136,368;Inherit;False;Property;_Mask_Power;Mask_Power;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-4800,352;Inherit;False;Property;_Mask_Multiply;Mask_Multiply;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-3856,96;Inherit;False;Property;_Erosion_Sub;Erosion_Sub;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;64;-3760,688;Inherit;False;Property;_Erosion_Intensity;Erosion_Intensity;26;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;125;-3184,640;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;126;-3200,128;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;75;-3024,160;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-2144,1328;Inherit;False;Property;_DepthFade;Depth Fade;22;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;77;-1184,2176;Inherit;False;3;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;78;-1184,2304;Inherit;False;Property;_CameraOffset;CameraOffset;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;81;-928,2160;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;82;-1184,1920;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;83;-1184,1664;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SaturateNode;87;-2112,1024;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;84;-800,1664;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;85;-672,2176;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0.01,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;-1792,1024;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;91;-2496,-112;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;89;-544,1664;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;86;-1536,1024;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;93;-1152,784;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;92;-288,1664;Inherit;False;CameraOffset;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-1344,112;Inherit;False;Property;_EmissiveIntensity;Emissive Intensity;23;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;-4192,480;Inherit;False;Property;_Erosion_Smoothness;Erosion_Smoothness;25;0;Create;True;0;0;0;False;0;False;0;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;108;-4848,-2288;Inherit;False;Property;_GradientColor_Scale;GradientColor_Scale;8;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;109;-4512,-2304;Inherit;False;Property;_GradientColor_Speed;GradientColor_Speed;14;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;113;-3968,-2688;Inherit;False;Property;_ColorTop;Color Top;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;114;-3968,-2944;Inherit;False;Property;_ColorBottom;Color Bottom;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;119;-2896,-432;Inherit;False;Property;_UseColor;UseColor;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_VFX_Adv_Particle_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638463808423533785;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638689749550715350;  Use Shadow Threshold;0;0;Cast Shadows;0;638463808434011469;Receive Shadows;0;638689749596548594;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;127;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=670AF0915F8D8A29A48A0B0A9B47EB9390E84A13