	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord23 = input.ase_texcoord4.xy * _NoiseDistortionScale + float2( 0,0 );
				...
				float2 texCoord47 = input.ase_texcoord4.xy * _MaskScale + _MaskOffset;
				float2 panner57 = ( windSpeed21 * appendResult52 + texCoord47);
				float2 texCoord58 = input.ase_texcoord4.xy * _MaskMoveScale + float2( 0,0 );
				float2 appendResult60 = (float2(input.ase_texcoord5.z , input.ase_texcoord5.w));
				float2 texCoord36 = input.ase_texcoord4.xy * _Noise01Scale + float2( 0,0 );
				float2 panner53 = ( windSpeed21 * _Noise01Speed + texCoord36);
				float2 texCoord43 = input.ase_texcoord4.xy * _Noise02Scale + float2( 0,0 );
				...
				float distanceDepth95 = saturate( ( screenDepth95 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( _Color * input.ase_color ) * temp_output_120_0 ) * _EmissionIntensity ).rgb;
				float Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( temp_output_120_0 * _OpacityBoost ) ) - ( input.ase_texcoord5.x + _Dissolve ) ) ) * distanceDepth95 ) ) ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float windSpeed21 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord23 = input.ase_texcoord2.xy * _NoiseDistortionScale + float2( 0,0 );
				float2 panner26 = ( windSpeed21 * _NoiseDistortionSpeed + texCoord23);
				float Distortion39 = ( ( tex2D( _NoiseDistortionTexture, panner26 ).r * 0.1 ) * _Distortion );
				float2 appendResult52 = (float2(_MaskSpeed , 0.0));
				float2 texCoord47 = input.ase_texcoord2.xy * _MaskScale + _MaskOffset;
				float2 panner57 = ( windSpeed21 * appendResult52 + texCoord47);
				float2 texCoord58 = input.ase_texcoord2.xy * _MaskMoveScale + float2( 0,0 );
				float2 appendResult60 = (float2(input.ase_texcoord3.z , input.ase_texcoord3.w));
				float2 texCoord36 = input.ase_texcoord2.xy * _Noise01Scale + float2( 0,0 );
				float2 panner53 = ( windSpeed21 * _Noise01Speed + texCoord36);
				float2 texCoord43 = input.ase_texcoord2.xy * _Noise02Scale + float2( 0,0 );
				float2 panner51 = ( windSpeed21 * _Noise02Speed + texCoord43);
				float Noises85 = saturate( ( pow( ( tex2D( _Noise_01_Texture, ( Distortion39 + panner53 ) ).r * tex2D( _Noise_02_Texture, ( Distortion39 + panner51 ) ).r ) , _NoisesPower ) * _NoisesMultiply ) );
				float temp_output_120_0 = saturate( ( saturate( ( saturate( ( pow( tex2D( _MaskTexture, ( ( Distortion39 * _DistortionIntensity ) + panner57 ) ).r , _MaskPower ) * _MaskMultiply ) ) * saturate( ( pow( tex2D( _MaskMoveTexture, ( texCoord58 + appendResult60 ) ).r , _MaskMovePower ) * _MaskMoveMultiply ) ) ) ) * Noises85 ) );
				...
				float Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( temp_output_120_0 * _OpacityBoost ) ) - ( input.ase_texcoord3.x + _Dissolve ) ) ) * distanceDepth95 ) ) ) );
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float windSpeed21 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord23 = input.ase_texcoord3.xy * _NoiseDistortionScale + float2( 0,0 );
				float2 panner26 = ( windSpeed21 * _NoiseDistortionSpeed + texCoord23);
				float Distortion39 = ( ( tex2D( _NoiseDistortionTexture, panner26 ).r * 0.1 ) * _Distortion );
				float2 appendResult52 = (float2(_MaskSpeed , 0.0));
				float2 texCoord47 = input.ase_texcoord3.xy * _MaskScale + _MaskOffset;
				float2 panner57 = ( windSpeed21 * appendResult52 + texCoord47);
				float2 texCoord58 = input.ase_texcoord3.xy * _MaskMoveScale + float2( 0,0 );
				float2 appendResult60 = (float2(input.ase_texcoord4.z , input.ase_texcoord4.w));
				float2 texCoord36 = input.ase_texcoord3.xy * _Noise01Scale + float2( 0,0 );
				float2 panner53 = ( windSpeed21 * _Noise01Speed + texCoord36);
				float2 texCoord43 = input.ase_texcoord3.xy * _Noise02Scale + float2( 0,0 );
				float2 panner51 = ( windSpeed21 * _Noise02Speed + texCoord43);
				float Noises85 = saturate( ( pow( ( tex2D( _Noise_01_Texture, ( Distortion39 + panner53 ) ).r * tex2D( _Noise_02_Texture, ( Distortion39 + panner51 ) ).r ) , _NoisesPower ) * _NoisesMultiply ) );
				float temp_output_120_0 = saturate( ( saturate( ( saturate( ( pow( tex2D( _MaskTexture, ( ( Distortion39 * _DistortionIntensity ) + panner57 ) ).r , _MaskPower ) * _MaskMultiply ) ) * saturate( ( pow( tex2D( _MaskMoveTexture, ( texCoord58 + appendResult60 ) ).r , _MaskMovePower ) * _MaskMoveMultiply ) ) ) ) * Noises85 ) );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				...
				float Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( temp_output_120_0 * _OpacityBoost ) ) - ( input.ase_texcoord4.x + _Dissolve ) ) ) * distanceDepth95 ) ) ) );
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float windSpeed21 = ( _WindSpeed * _TimeParameters.x );
				float2 texCoord23 = input.ase_texcoord.xy * _NoiseDistortionScale + float2( 0,0 );
				float2 panner26 = ( windSpeed21 * _NoiseDistortionSpeed + texCoord23);
				float Distortion39 = ( ( tex2D( _NoiseDistortionTexture, panner26 ).r * 0.1 ) * _Distortion );
				float2 appendResult52 = (float2(_MaskSpeed , 0.0));
				float2 texCoord47 = input.ase_texcoord.xy * _MaskScale + _MaskOffset;
				float2 panner57 = ( windSpeed21 * appendResult52 + texCoord47);
				float2 texCoord58 = input.ase_texcoord.xy * _MaskMoveScale + float2( 0,0 );
				float2 appendResult60 = (float2(input.ase_texcoord1.z , input.ase_texcoord1.w));
				float2 texCoord36 = input.ase_texcoord.xy * _Noise01Scale + float2( 0,0 );
				float2 panner53 = ( windSpeed21 * _Noise01Speed + texCoord36);
				float2 texCoord43 = input.ase_texcoord.xy * _Noise02Scale + float2( 0,0 );
				float2 panner51 = ( windSpeed21 * _Noise02Speed + texCoord43);
				float Noises85 = saturate( ( pow( ( tex2D( _Noise_01_Texture, ( Distortion39 + panner53 ) ).r * tex2D( _Noise_02_Texture, ( Distortion39 + panner51 ) ).r ) , _NoisesPower ) * _NoisesMultiply ) );
				float temp_output_120_0 = saturate( ( saturate( ( saturate( ( pow( tex2D( _MaskTexture, ( ( Distortion39 * _DistortionIntensity ) + panner57 ) ).r , _MaskPower ) * _MaskMultiply ) ) * saturate( ( pow( tex2D( _MaskMoveTexture, ( texCoord58 + appendResult60 ) ).r , _MaskMovePower ) * _MaskMoveMultiply ) ) ) ) * Noises85 ) );
				...
				surfaceDescription.Alpha = saturate( ( input.ase_color.a * saturate( ( saturate( ( saturate( ( temp_output_120_0 * _OpacityBoost ) ) - ( input.ase_texcoord1.x + _Dissolve ) ) ) * distanceDepth95 ) ) ) );
...
Node;AmplifyShaderEditor.CommentaryNode;88;-1892.561,448.254;Inherit;False;855;550;Depth Fade;4;104;100;95;91;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;27;-4725.79,-1488.679;Inherit;True;Property;_NoiseDistortionTexture;Noise Distortion Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;62;-7446.341,-1253.194;Inherit;True;Property;_Noise_01_Texture;Noise_01_Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;65;-7481.817,-860.8062;Inherit;True;Property;_Noise_02_Texture;Noise_02_Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;66;-6066.566,882.2541;Inherit;True;Property;_MaskTexture;Mask Texture;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;67;-6066.566,1394.254;Inherit;True;Property;_MaskMoveTexture;Mask Move Texture;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SaturateNode;86;-4768,1136;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;120;-3920,240;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;95;-1842.561,754.2542;Inherit;False;True;True;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;119;-2080,496;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;113;-2226.562,-1037.746;Inherit;False;Property;_Color;Color;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;SH_Vefects_VFX_URP_Particles_Erosion_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;True;True;2;5;True;_Src1;10;True;_Dst1;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638311092170185038;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638733965981730071;  Use Shadow Threshold;0;0;Cast Shadows;1;0;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;True;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;121;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=5072BC098A560EB1605A52E0A43F6F70496D117D