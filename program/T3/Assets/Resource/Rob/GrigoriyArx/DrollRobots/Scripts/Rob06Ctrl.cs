...
public class Rob06Ctrl : MonoBehaviour
{
    ...
    IEnumerator StartDelay()
    {
        ...
        bullet1.GetComponent<Rigidbody>().linearVelocity = BulletSpawnPoint[0].forward * bulletSpeed;
        var bullet2 = Instantiate(bulletPrefab, BulletSpawnPoint[1].position, BulletSpawnPoint[1].rotation);
        bullet2.GetComponent<Rigidbody>().linearVelocity = BulletSpawnPoint[1].forward * bulletSpeed;
    }
}
